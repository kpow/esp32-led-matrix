...
<body>
  ...
  <script>
    const botExprNames = ["Neutral", "Happy", "Sad", "Surprised", "Sleepy", "Angry", "Love", "Dizzy", "Thinking", "Excited", "Mischief", "Dead", "Skeptical", "Worried", "Confused", "Proud", "Shy", "Annoyed", "Bliss", "Focused", "Winking", "Devious", "Shocked", "Kissing", "Nervous", "Glitching", "Sassy"];
