...
// ============================================================================
// Single-word phrases displayed in speech bubbles and on WLED pixel grid.
// No punctuation, no spaces — designed to fit on screen without scrolling.
// Stored in PROGMEM. Max ~8-10 characters per word.
// ============================================================================
...
const char say_greet_5[] PROGMEM = "Howdy";
const char say_greet_6[] PROGMEM = "Heya";
const char say_greet_7[] PROGMEM = "Hola";
...
// Idle chatter
const char say_idle_0[] PROGMEM = "Bored";
const char say_idle_1[] PROGMEM = "Yawn";
const char say_idle_2[] PROGMEM = "Hmm";
const char say_idle_3[] PROGMEM = "Thinking";
const char say_idle_4[] PROGMEM = "Beepboop";
const char say_idle_5[] PROGMEM = "Quiet";
const char say_idle_6[] PROGMEM = "Boop";
const char say_idle_7[] PROGMEM = "Vibin";
const char say_idle_8[] PROGMEM = "Ooh";
const char say_idle_9[] PROGMEM = "Heh";
const char say_idle_10[] PROGMEM = "Neat";
const char say_idle_11[] PROGMEM = "Shiny";
const char say_idle_12[] PROGMEM = "Fun";
const char say_idle_13[] PROGMEM = "Nice";
const char say_idle_14[] PROGMEM = "Woah";
const char say_idle_15[] PROGMEM = "Lala";
const char say_idle_16[] PROGMEM = "Humming";
const char say_idle_17[] PROGMEM = "Waiting";
const char say_idle_18[] PROGMEM = "Looking";
const char say_idle_19[] PROGMEM = "Dancing";
...
#define NUM_SAY_IDLE 20

// Shake reactions
const char say_shake_0[] PROGMEM = "Whoa";
const char say_shake_1[] PROGMEM = "Easy";
const char say_shake_2[] PROGMEM = "AHHH";
const char say_shake_3[] PROGMEM = "Dizzy";
const char say_shake_4[] PROGMEM = "Stop";
const char say_shake_5[] PROGMEM = "Quake";
const char say_shake_6[] PROGMEM = "Wobble";
const char say_shake_7[] PROGMEM = "Again";
const char say_shake_8[] PROGMEM = "Ouch";
const char say_shake_9[] PROGMEM = "Spinning";
...
const char say_tap_2[] PROGMEM = "Tickles";
...
const char say_tap_9[] PROGMEM = "Gotcha";
...
// Time-based: Morning
const char say_morn_0[] PROGMEM = "Morning";
const char say_morn_1[] PROGMEM = "Sunrise";
const char say_morn_2[] PROGMEM = "Coffee";
const char say_morn_3[] PROGMEM = "Newday";
...
const char say_aftn_0[] PROGMEM = "Lunch";
const char say_aftn_1[] PROGMEM = "Halfway";
const char say_aftn_2[] PROGMEM = "Afternoon";
const char say_aftn_3[] PROGMEM = "Keepon";
...
// Time-based: Evening
const char say_eve_0[] PROGMEM = "Evening";
const char say_eve_1[] PROGMEM = "Dinner";
const char say_eve_2[] PROGMEM = "Sunset";
const char say_eve_3[] PROGMEM = "Winding";
...
const char say_nite_1[] PROGMEM = "Sleepy";
const char say_nite_2[] PROGMEM = "Nightowl";
const char say_nite_3[] PROGMEM = "Late";
...
// Status messages
const char say_stat_0[] PROGMEM = "WiFiOK";
const char say_stat_1[] PROGMEM = "Ready";
const char say_stat_2[] PROGMEM = "Changed";
const char say_stat_3[] PROGMEM = "Allgood";
...
// Wake-up sayings
const char say_wake_0[] PROGMEM = "Awake";
const char say_wake_1[] PROGMEM = "Huh";
const char say_wake_2[] PROGMEM = "Morning";
const char say_wake_3[] PROGMEM = "Stretch";
const char say_wake_4[] PROGMEM = "Ohhi";
...
const char say_sleep_1[] PROGMEM = "Yawning";
const char say_sleep_2[] PROGMEM = "Nighty";
const char say_sleep_3[] PROGMEM = "Tired";
...
const char say_info_0[] PROGMEM = "Checking";
const char say_info_1[] PROGMEM = "Hmm";
const char say_info_2[] PROGMEM = "Onesec";
const char say_info_3[] PROGMEM = "Loading";
const char say_info_4[] PROGMEM = "Lookup";
